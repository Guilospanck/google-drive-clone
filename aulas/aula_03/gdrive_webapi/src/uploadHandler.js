...
export default class UploadHandler {
  ...
  // back pressure: manipulate the "pressure" we send info
  ...
  async onFile(fieldname, file, filename) {
    ...
    await pipeline(
      // First step: take the readable stream
      file,
      // second step: filter, convert and tranform data
      this.handleFileBytes.apply(this, [filename]),
      // third step: exit of the process, a writable stream
